...
export default async function Home() {
  ...
  return <>
    ...
    <section className="community-section"><Reveal className="wrap"><div className="section-heading"><h2>Big ideas.<br />Better company.</h2><p>From a first question to a new collaboration,<br className="desktop-break" /> it starts with a conversation.</p></div><div className="photo-montage"><figure><Image src={communityPhotos[0]} alt="AI Discussion Club members gathered after a discussion" width={1820} height={866} sizes="(max-width: 700px) 92vw, (max-width: 1336px) 93vw, 1240px"/></figure><figure><Image src={communityPhotos[1]} alt="Club members together at a bookstore" width={900} height={600} sizes="(max-width: 700px) 92vw, 45vw"/></figure><figure><Image src={communityPhotos[2]} alt="Club members in front of the Lincoln Memorial" width={900} height={900} sizes="(max-width: 700px) 92vw, 45vw"/></figure></div><div className="community-caption"><p>Different backgrounds. A shared curiosity.</p><Link href="/about" className="button secondary">Meet the club</Link></div></Reveal></section>
